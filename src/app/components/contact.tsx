  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe
        ...
        marginWidth={0}
        scrolling="no"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.380657233513!2d67.02340577442928!3d24
        .85084544564403!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33e75a28531d1%3A0x412558657f5ff4a8!
        2sGovernor%20House%20Karachi!5e0!3m2!1sen!2s!4v1731103946998!5m2!1sen!2s"
      ...
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <a className="text-green-500 leading-relaxed">sobiaarf1728@email.com</a>
    ...
    <h1 className="title-font sm:text-6xl mb-4 font-medium text-black">
      ...
      <div className="relative mb-4">
        <label htmlFor="email" className="leading-7 text-2xl text-gray-600">
          Email
        </label>
        <input
          type="email"
      ...
      <div className="relative mb-4">
        <label htmlFor="message" className="leading-7 text-2xl text-gray-600">
          Message
        </label>
        <textarea
          id="message"
